...
const ListRoom = () => {
  ...
  return (
    <div>
      ...
      <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll mt-3 mb-12'>
                ...
                <td className='py-3 px-4 border-t border-gray-300 text-sm text-center'>
                  <label htmlFor="" className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                    <input
                      ...
                      onChange={() => toggleAvailability(index)} // Handle checkbox click
                    />
